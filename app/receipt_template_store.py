...
def default_template() -> dict[str, Any]:
    ...
    # Keep one source of truth for customer receipts.  The editable runtime
    # file is also the fallback used when it has not been created yet.
    bundled_path = template_path()
    try:
